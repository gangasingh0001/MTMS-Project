...
import Replicas.Server.Constant.ServiceConstant;
import Replicas.Server.Service.MovieTicket;
import Replicas.Server.Shared.Database.ICustomerBooking;
import Replicas.Server.Shared.Database.IMovies;
import Replicas.Server.Shared.data.IMovie;
import Replicas.Server.Shared.data.IServerInfo;
import Replicas.Server.Shared.data.IUdp;
...
public class Server extends Thread{
    ...
    private void requestlistener(MovieTicket movieTicketObj, int serverPort, String serverName) {
        ...
        System.out.println("Listener Datagram port : "+serverPort);
